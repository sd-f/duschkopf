...
@XmlType(name = "", propOrder = {
    "contourPolyline2DOrNurbsCurve2DOrNurbsCurve"
})
@XmlRootElement(name = "NurbsSweptSurface")
public class NurbsSweptSurface
    extends X3DParametricGeometryNode
{
    ...
    protected List<Object> contourPolyline2DOrNurbsCurve2DOrNurbsCurve;
    ...
    /**
     * Gets the value of the contourPolyline2DOrNurbsCurve2DOrNurbsCurve property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the contourPolyline2DOrNurbsCurve2DOrNurbsCurve property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContourPolyline2DOrNurbsCurve2DOrNurbsCurve().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getContourPolyline2DOrNurbsCurve2DOrNurbsCurve() {
        if (contourPolyline2DOrNurbsCurve2DOrNurbsCurve == null) {
            contourPolyline2DOrNurbsCurve2DOrNurbsCurve = new ArrayList<Object>();
        }
        return this.contourPolyline2DOrNurbsCurve2DOrNurbsCurve;
    }
