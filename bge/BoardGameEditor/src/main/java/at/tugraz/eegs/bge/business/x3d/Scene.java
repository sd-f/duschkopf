...
@XmlType(name = "", propOrder = {
    "metadataDoubleOrMetadataFloatOrMetadataInteger"
})
    ...
    extends SceneGraphStructureNodeType
{
    ...
    protected List<Object> metadataDoubleOrMetadataFloatOrMetadataInteger;

    /**
     * Gets the value of the metadataDoubleOrMetadataFloatOrMetadataInteger property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the metadataDoubleOrMetadataFloatOrMetadataInteger property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMetadataDoubleOrMetadataFloatOrMetadataInteger().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getMetadataDoubleOrMetadataFloatOrMetadataInteger() {
        if (metadataDoubleOrMetadataFloatOrMetadataInteger == null) {
            metadataDoubleOrMetadataFloatOrMetadataInteger = new ArrayList<Object>();
        }
        return this.metadataDoubleOrMetadataFloatOrMetadataInteger;
    }
